...
// Hier wordt gecontroleerd of de klant het juiste wachtwoord heeft ingevoerd
    ...
    if (isset($_POST['gebruikersnaam']) && isset($_POST['password']))
    {
		...
		//De gebruikersnaam is niet vindbaar bij de exit staat de naam localhost is.
		...
		// bij de foutmeldingen zie je bij alle query's een notice staan, dat is omdat er nog niks is ingevuld, Maar ook dat er een unkown colum is, namelijk klantnummer, deze moet nog aangemaakt worden.
		exit($query);
